...
def tranformer_forward(
    ...
    **params: dict,
    ...
    if use_condition:
        t = []
        for condition_latent, adapter_name in zip(condition_latents, condition_names):
            with specify_lora((self.x_embedder,), adapter_name):
                t.append(self.x_embedder(condition_latent))
        condition_latents = t
    ...
    if use_condition:
        ...
        cond_rotary_emb = [
            self.pos_embed(condition_id) for condition_id in condition_ids
        ]
        ...
        if self.training and self.gradient_checkpointing:
            ...
            encoder_hidden_states, hidden_states, condition_latents = (
                torch.utils.checkpoint.checkpoint(
                    ...
                    condition_names=condition_names if use_condition else None,
