...
def generate(
    ...
    **params: dict,
    ...
    condition_names = [condition.condition_type for condition in conditions]

    pipeline.set_adapters(
        list(set([condition.condition_type for condition in conditions]))
    )
    ...
    with self.progress_bar(total=num_inference_steps) as progress_bar:
        for i, t in enumerate(timesteps):
            ...
            if cache_per_n_steps:
                use_condition = i % cache_per_n_steps == 0
